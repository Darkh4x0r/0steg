...
success=echo -e "\e[31mInstalling Ssuccessful\e[0m""\n"
...
echo "deb http://old.kali.org/kali moto main non-free contrib" | sudo tee /etc/apt/sources.list
echo "deb http://ap-northeast-2.ec2.archive.ubuntu.com/ubuntu/ bionic-updates main restricted" | sudo tee /etc/apt/sources.list
echo "deb http://ap-northeast-2.ec2.archive.ubuntu.com/ubuntu/ bionic universe" | sudo tee /etc/apt/sources.list
echo "deb http://ap-northeast-2.ec2.archive.ubuntu.com/ubuntu/ bionic-updates universe" | sudo tee /etc/apt/sources.list
echo "deb http://ap-northeast-2.ec2.archive.ubuntu.com/ubuntu/ bionic multiverse" | sudo tee /etc/apt/sources.list
echo "deb http://ap-northeast-2.ec2.archive.ubuntu.com/ubuntu/ bionic-updates multiverse" | sudo tee /etc/apt/sources.list
echo "deb http://ap-northeast-2.ec2.archive.ubuntu.com/ubuntu/ bionic-backports main restricted universe multiv" | sudo tee /etc/apt/sources.list
echo "deb http://security.ubuntu.com/ubuntu/ bionic-security universe"| sudo tee /etc/apt/sources.list
...
echo -e "\e[31mDownloading tools commands\e[0m""\n"

wget " https://raw.githubusercontent.com/Darkh4x0r/0steg/main/Commands.txt"
